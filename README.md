...
Para instalar la herramienta de pruebas, escribir en la consola: pip install pytest

Para comprobar que los cálculos estadísticos son correctos: python -m pytest tests/test_processor.py

Para iniciar el programa principal: python main.py
